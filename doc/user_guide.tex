...
\item \verb+blacs_single_column+: whether to create an $N\times1$ BLACS process grid where $N$ is the number of processes. If false, then a rectangular process grid is created with \verb+MPI_Dims_create+.
