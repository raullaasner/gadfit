...
\item \textbf{Compilation stage.} The code should run without any warning with GFortran and preferably also with Ifort, although the latter is not a requirement.
...
\item Use the body to explain the \textit{what} and \textit{why} and not the \textit{how} (see this post \url{https://chris.beams.io/posts/git-commit} for an explanation)
\end{itemize}
...
\noindent\textbf{Operating systems used for testing}
